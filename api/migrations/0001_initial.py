# Generated by Django 5.2.6 on 2025-10-05 09:58
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('required_funds', models.DecimalField(decimal_places=2, default=0.0, max_digits=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.CharField(choices=[('going', 'Going'), ('not_going', 'Not Going'), ('thinking', 'Thinking')], default='thinking', max_length=10)),
