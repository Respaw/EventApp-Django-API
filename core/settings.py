...
SECRET_KEY = 'django-insecure-91=i-w3pfcnu5+tjrx!^4_qcyxgd)mx2cioo@_szmfov=j9t$s'
...
SIMPLE_JWT = {
    "ACCESS_TOKEN_LIFETIME": timedelta(minutes=60),  # Access-токен истекает через 60 минут
    "REFRESH_TOKEN_LIFETIME": timedelta(days=7),   # Refresh-токен истекает через 7 дней
    "ROTATE_REFRESH_TOKENS": True,                 # При обновлении refresh-токен тоже меняется
    "BLACKLIST_AFTER_ROTATION": True,              # Старый refresh-токен становится недействительным
    "UPDATE_LAST_LOGIN": False,
    "ALGORITHM": "HS256",
    "SIGNING_KEY": SECRET_KEY,                     # Использует ваш SECRET_KEY
    "VERIFYING_KEY": "",
    "AUDIENCE": None,
    "ISSUER": None,
    "JWK_URL": None,
    ...
    "TOKEN_TYPE_PAIR": "rest_framework_simplejwt.serializers.TokenObtainPairSerializer",
